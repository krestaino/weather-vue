    ...
    <div class="current">
        ...
        <div class="row">
            ...
            <ul class="col details">
                ...
                <li>
                    Sunrise: <strong>{{ timestamp(store.weather.daily.data[0].sunriseTime * 1000, store.weather.timezone)
                    }}</strong>
                </li>
                <li>
                    Sunset: <strong>{{ timestamp(store.weather.daily.data[0].sunsetTime * 1000, store.weather.timezone)
                    }}</strong>
                </li>
            </ul>
        </div> <!-- end .row -->
